...
/**
 * The service provider for implementations of the Jakarta Configuration specification.
 * <p>
...
public abstract class ConfigProviderResolver {
     ...
     * manually specified, that instance is returned. Otherwise, {@link java.util.ServiceLoader} is used to locate the first
